...
namespace Capstone_Flowershop
{
    public static class Connect
    {
        ...
        public static string connectionStrings = $"Server=DESKTOP-IH4V487\\NEWMSSQL;Database=FlowershopSystemDB;Integrated Security=True;";
        public static string connectionString = $"Data Source=DESKTOP-IH4V487\\NEWMSSQL;AttachDbFilename=D:\\CapstoneProject-RogerAcierda\\FlowershopSystemDB.mdf;Initial Catalog=FlowershopSystemDB;Integrated Security=True";
    }
